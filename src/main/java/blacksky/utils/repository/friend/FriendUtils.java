package blacksky.utils.repository.friend;
...
public final class FriendUtils {
    ...
    public static void load() {
        setFriends(RepositoryStorage.loadStringList("friends.blacksky", "friends"));
    }

    public static void save() {
        RepositoryStorage.saveStringList("friends.blacksky", "friends", getFriendNames());
    }
