package blacksky.utils.render.world.glow;
...
public final class Glow3D {
    ...
    public static void init() {
        ...
        pipeline = RenderPipeline.builder()
                .withLocation(Identifier.fromNamespaceAndPath("blacksky", "pipeline/world/glow3d"))
                .withVertexShader(Identifier.fromNamespaceAndPath("blacksky", "world/glow3d/glow3d"))
                .withFragmentShader(Identifier.fromNamespaceAndPath("blacksky", "world/glow3d/glow3d"))
