package blacksky.utils.render.world.starsparkle;
    ...
    public static void init() {
        ...
        try {
            ...
            pipeline = RenderPipeline.builder()
                    .withLocation(Identifier.fromNamespaceAndPath("blacksky", "pipeline/world/starsparkle"))
                    .withVertexShader(Identifier.fromNamespaceAndPath("blacksky", "world/shared/particle_billboard"))
                    .withFragmentShader(Identifier.fromNamespaceAndPath("blacksky", "world/starsparkle/starsparkle"))
