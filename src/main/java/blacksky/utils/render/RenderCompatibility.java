...
public final class RenderCompatibility {
    ...
    private static final String SAFE_WORLD_EFFECTS_PROPERTY = "blacksky.safeWorldEffects";
    private static final String SAFE_WORLD_EFFECTS_ENV = "BLACKSKY_SAFE_WORLD_EFFECTS";

    private static Boolean disableFragEffectScanShader;
    private static String disableFragEffectScanShaderReason = "unresolved";
    private static final String DISABLE_FRAG_EFFECT_SCAN_PROPERTY = "blacksky.disableFragEffectScanShader";
    private static final String DISABLE_FRAG_EFFECT_SCAN_ENV = "BLACKSKY_DISABLE_FRAG_EFFECT_SCAN_SHADER";
